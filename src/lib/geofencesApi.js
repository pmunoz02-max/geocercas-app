...
// Nueva versión solo frontend: usa API
export async function listGeofences(orgId, onlyActive) {
...
// (Eliminado helper geofencesHasTenantId: no debe existir en frontend)