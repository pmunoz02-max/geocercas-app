...
const copy = {
  es: { title: "Visitas con foto y ubicaci\u00f3n", badge: "Opcional", short: "Documenta tus visitas con notas, resultados y hasta cinco fotos opcionales con ubicaci\u00f3n al adjuntarla.", detail: "El propietario o administrador activa Visitas para su organizaci\u00f3n. Cada persona decide cu\u00e1ndo registrar una visita: selecciona una geocerca, indica el motivo, a\u00f1ade notas y finaliza el registro. Puedes adjuntar hasta cinco fotos del sitio, de los presentes o de un documento (JPG/PNG, hasta 2 MB por foto). La ubicaci\u00f3n corresponde al momento de adjuntar la foto.", activation: "Activaci\u00f3n por el propietario o administrador; registro voluntario.", cta: "Abrir Visitas" },
  en: { title: "Visits with photo and location", badge: "Optional", short: "Document visits with notes, outcomes and up to five optional photos with location recorded when attached.", detail: "The owner or administrator enables Visits for the organization. Each person chooses when to record a visit: select a geofence, enter its purpose, add notes and finish the record. Attach up to five photos of the site, attendees or a document (JPG/PNG, up to 2 MB per photo). Location is recorded when the photo is attached.", activation: "Enabled by the owner or administrator; voluntary recording.", cta: "Open Visits" },
  fr: { title: "Visites avec photo et localisation", badge: "Facultatif", short: "Documentez vos visites avec des notes, des r\u00e9sultats et jusqu\u2019\u00e0 cinq photos facultatives localis\u00e9e au moment de son ajout.", detail: "Le propri\u00e9taire ou l’administrateur active Visites pour son organisation. Chaque personne choisit quand enregistrer une visite : s\u00e9lectionnez un g\u00e9orep\u00e8re, indiquez le motif, ajoutez des notes et terminez la visite. Joignez jusqu\u2019\u00e0 cinq photos du site, des personnes pr\u00e9sentes ou d’un document (JPG/PNG, 2 Mo par photo). La position est relev\u00e9e lors de l’ajout de la photo.", activation: "Activation par le propri\u00e9taire ou l’administrateur ; enregistrement volontaire.", cta: "Ouvrir Visites" }
};
