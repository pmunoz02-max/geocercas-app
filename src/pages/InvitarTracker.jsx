...
Deno.serve(async (req) => {
  ...
  try {
    ...
    // ✅ Validación contractual: personal debe existir en org
    ...
    // si usuario existe -> magiclink, si no -> invite
    ...
    return json(forbidden ? 403 : 400, { ok: false, code: forbidden ? "FORBIDDEN" : "BAD_REQUEST", message: msg });
  }
});
