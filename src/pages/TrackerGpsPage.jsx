...
export default function TrackerGpsPage() {
  ...
  async function acceptTrackerInvite(inviteToken, orgId) {
    ...
    try {
      ...
      // Redirect obligatorio a /tracker-gps
      const lang = (typeof window !== "undefined" && (new URLSearchParams(window.location.search).get("lang"))) || "es";
      const nextUrl = `/tracker-gps?org_id=${encodeURIComponent(orgId)}&lang=${encodeURIComponent(lang)}`;
