...
// - org activa: AuthContext (backend) + compat tg_current_org_id (storage)
...
export default function ActividadesPage() {
  ...
  const { loading, isAuthenticated, user, role, currentRole, currentOrg } = useAuth();
  ...
  async function load() {
    if (!activeOrgId) {
      ...
      setErrorMsg(
        t("actividades.errorMissingTenant", { defaultValue: "No se encontró la organización del usuario." })
      );
      return;
    }
