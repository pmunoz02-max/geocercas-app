    ...
    <div className="min-h-screen bg-gray-50 flex flex-col items-center justify-center p-6">
      <header className="w-full max-w-2xl text-center mb-12">
        <h1 className="text-4xl font-bold mb-4 text-blue-900">
          Control de personal con geocercas
        </h1>
        <p className="text-lg text-gray-700 mb-6">
          Optimiza la supervisión de tu equipo y automatiza reportes de asistencia usando geocercas y tecnología móvil.
        </p>
        <button
          className="bg-blue-700 hover:bg-blue-800 text-white font-semibold px-6 py-3 rounded shadow"
      ...
      <section className="w-full max-w-xl bg-white rounded-lg shadow p-6 mb-12">
        <h2 className="text-2xl font-semibold mb-2 text-blue-800">Precios</h2>
        <ul className="text-gray-700 space-y-2">
          <li>
            <span className="font-bold">Plan Básico:</span> Gratis para hasta 3 trackers.
          </li>
          <li>
            <span className="font-bold">Plan Pro:</span> $9 USD/mes por organización, hasta 50 trackers.
          </li>
          <li>
            <span className="font-bold">Plan Empresas:</span> Consultar para más de 50 trackers.
          </li>
        </ul>
      </section>

      <section className="w-full max-w-xl bg-white rounded-lg shadow p-6">
        <h2 className="text-2xl font-semibold mb-2 text-blue-800">Contacto</h2>
