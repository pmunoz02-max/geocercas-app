# Canonical Tracker Personal Resolution Flow (Preview)

## Resumen

- El usuario invita a un tracker personal desde el panel.
...
- El cliente (Android/WebView) almacena el **tracker runtime token opaco** y lo usa para autenticarse.
