-- 00244_preview_prereq__api_register_event.sql
...
create or replace function public.api_register_event(
  p_user uuid,
...
comment on function public.api_register_event(uuid,double precision,double precision,timestamptz)
