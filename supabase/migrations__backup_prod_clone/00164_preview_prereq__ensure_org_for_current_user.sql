-- 00164_preview_prereq__ensure_org_for_current_user.sql
-- PREREQ bootstrap-safe: solo para permitir que 00300_preview_rls.sql avance.
-- Será redefinida por 00400_preview_vft.sql.

create or replace function public.ensure_org_for_current_user()
returns uuid
language plpgsql
security definer
...
grant execute on function public.ensure_org_for_current_user() to anon, authenticated;
