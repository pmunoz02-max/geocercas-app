...
DO $$
BEGIN
  IF to_regclass('public.latest_tracker_position') IS NOT NULL THEN
    EXECUTE '
      CREATE INDEX IF NOT EXISTS idx_latest_tracker_position_tracker
      ON public.latest_tracker_position USING btree (tracker_id)
    ';
  END IF;
END $$;
...
BEGIN
  IF EXISTS (
    ...
    WHERE n.nspname = 'public'
      ...
      AND t.tgname = 'trg_ensure_org_for_new_admin'
      AND NOT t.tgisinternal
  ) THEN
    EXECUTE 'ALTER TABLE public.memberships ENABLE TRIGGER trg_ensure_org_for_new_admin';
  END IF;
END $$;
...
BEGIN
  IF EXISTS (
    ...
    WHERE n.nspname = 'public'
      AND c.relname = 'memberships'
      AND t.tgname = 'trg_membership_audit'
      AND NOT t.tgisinternal
  ) THEN
    EXECUTE 'ALTER TABLE public.memberships DISABLE TRIGGER trg_membership_audit';
  END IF;
END $$;
...
BEGIN
  IF EXISTS (
    ...
    WHERE n.nspname = 'public'
      ...
      AND t.tgname = 'trg_prevent_personal_duplicate_on_undelete'
      AND NOT t.tgisinternal
  ) THEN
    EXECUTE 'ALTER TABLE public.personal DISABLE TRIGGER trg_prevent_personal_duplicate_on_undelete';
  END IF;
END $$;
...
BEGIN
  IF EXISTS (
    ...
    WHERE n.nspname = 'public'
      AND c.relname = 'memberships'
      AND t.tgname = 'zzz_one_admin_memberships'
      AND NOT t.tgisinternal
  ) THEN
    EXECUTE 'ALTER TABLE public.memberships DISABLE TRIGGER zzz_one_admin_memberships';
  END IF;
END $$;
...
BEGIN
  IF EXISTS (
    ...
    WHERE n.nspname = 'public'
      AND c.relname = 'personal'
      AND t.tgname = 'zzz_personal_biu_defaults'
      AND NOT t.tgisinternal
  ) THEN
    EXECUTE 'ALTER TABLE public.personal DISABLE TRIGGER zzz_personal_biu_defaults';
  END IF;
END $$;
